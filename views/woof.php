...
//***
                    ...
                    <div class="woo_submit_search_form_container">
                        ...
                        <?php if (isset($_GET[$this->get_swoof_search_slug()])): global $woof_link; ?>
                        ...
                        <?php if (!$woof_autosubmit): ?>
                            ...
                            ?>
                            <button style="float: left;" class="button woo_submit_search_form"><?php echo $woof_filter_btn_txt ?></button>
                        <?php endif; ?>

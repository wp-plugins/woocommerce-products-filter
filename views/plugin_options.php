...
<div class="subsubsub_section">
    ...
    <div class="section">
        ...
        <?php if (class_exists('SitePress')): ?>
            ...
            <h3 style="margin-bottom: 5px;"><?php _e('WPML taxonomies labels translations', 'woocommerce-products-filter') ?> <img class="help_tip" data-tip="Syntax:
                                                                                                                                   es:Locations^Ubicaciones
                                                                                                                                   es:Size^Tamaño
                                                                                                                                   de:Locations^Lage
                                                                                                                                   de:Size^Größe" src="<?php echo WP_PLUGIN_URL ?>/woocommerce/assets/images/help.png" height="16" width="16" /></h3>

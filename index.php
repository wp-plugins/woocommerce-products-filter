...
//+++
    ...
    public function get_options() {
        $options = array
            ...
            array(
                'name' => __('Show dynamic count', 'woocommerce-products-filter'),
                'desc' => __('Show count of items near taxonomies terms on the front dynamicaly. Must be switched on "Show count"', 'woocommerce-products-filter'),
             ...
             array(
                'name' => __('Hide empty terms dynamic count', 'woocommerce-products-filter'),
                'desc' => __('Hide empty terms in "Show dynamic count" mode', 'woocommerce-products-filter'),
    ...
    public static function dynamic_count($curr_term, $type) {
        if (!isset($_GET['swoof']) AND !isset($_REQUEST['WOOF_IS_TAX_PAGE'])) {
